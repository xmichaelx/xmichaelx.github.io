...
If you're using Linux or OSX you can probably already have Python. For other two dependencies you should follow: link:https://www.scipy.org/install.html[SciPy download]  and http://scikit-image.org/download.html.
