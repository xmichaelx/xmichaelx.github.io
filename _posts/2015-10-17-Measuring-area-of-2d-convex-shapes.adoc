...
Coin on the first image is a link:https://en.wikipedia.org/wiki/Polish_coins_and_banknotes[polish 2 grosze], which has a diameter of 17,5 mm. Which gives area of 240,528 square milimeters. 
