...
We assume that shapes will are link:https://en.wikipedia.org/wiki/Polygon#Convexity_and_non-convexity[convex]. This will allow us to use convex hulls to compute areas of the found shapes.
