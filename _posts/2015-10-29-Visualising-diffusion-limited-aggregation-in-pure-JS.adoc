...
image:dla/36.png[DLA,400] 
image:dla/62.png[DLA,400]

Above we can see DLA cluster grown as result of our implementation.
...
++++
<?dbhtml-include href="https://raw.githubusercontent.com/xmichaelx/xmichaelx.github.io/master/files/dla/dla.html"?>
++++
